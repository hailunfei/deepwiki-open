          ...
          {allowPlatformChange && (
            <div className="mb-3">
              ...
              <div className="flex gap-2">
                ...
                <button
                  type="button"
                  onClick={() => setSelectedPlatform('gitee')}
                  className={`flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-md border transition-all ${selectedPlatform === 'gitee'
                    ? 'bg-[var(--accent-primary)]/10 border-[var(--accent-primary)] text-[var(--accent-primary)] shadow-sm'
                    : 'border-[var(--border-color)] text-[var(--foreground)] hover:bg-[var(--background)]'
                    }`}
                >
                  <span className="text-sm">gitee</span>
                </button>
              </div>
            </div>
          )}
